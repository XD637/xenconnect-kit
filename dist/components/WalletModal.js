...
var _XenConnectProvider = require("./XenConnectProvider");
...
var WalletModal = function WalletModal(_ref) {
  ...
  var _useXenConnect = (0, _XenConnectProvider.useXenConnect)(),
    projectId = _useXenConnect.projectId,
    appName = _useXenConnect.appName; // Get values from context
  var _useConnect = (0, _wagmi.useConnect)(),
    connect = _useConnect.connect,
    isLoading = _useConnect.isLoading;
  ...
  var handleConnect = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(walletName, connector) {
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            console.error("Connection failed:", _context.t0);
          case 9:
            _context.prev = 9;
    ...
    return function handleConnect(_x, _x2) {
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
    ...
    return /*#__PURE__*/_react["default"].createElement("button", {
      ...
      onClick: function onClick() {
        return handleConnect(name, connector);
      },
