...
const WalletModal = ({ isOpen, onClose }) => {
  ...
  const wallets = [
    { name: "MetaMask", connector: injected(), logo: "/src/assets/metamask-logo.svg" },
    { name: "WalletConnect", connector: walletConnect({ projectId }), logo: "/src/assets/walletconnect-logo.svg" },
    { name: "Coinbase Wallet", connector: coinbaseWallet({ appName }), logo: "/src/assets/coinbase-logo.svg" },
  ];
